...
function SettingsManager:BuildSettingsSection(Section)
    Section:AddSubHeader("Menu Toggle & Shortcuts", "rbxassetid://10734950309")
    ...
    Section:AddToggle({
        Name = "Show Keybind Badges on Toggles",
    ...
    if NamelessWare.ActiveWindow and NamelessWare.ActiveWindow.MobileBtn then
        Section:AddSubHeader("Mobile Touch Controls", "rbxassetid://109254181370156")
        ...
        Section:AddButton({
            Name = "Reset Mobile Button Position",
            Callback = function()
                NamelessWare.ActiveWindow.MobileBtn.Position = UDim2.new(0, 16, 0.5, -25)
                NamelessWare:Notify({
                    Title = "Button Reset",
                    Content = "Mobile button position restored to screen edge.",
                    Duration = 1.5,
                    Type = "Info"
                })
            end
    ...
    Section:AddSubHeader("On-Screen HUD Overlays", "rbxassetid://10734975692")
    ...
    Section:AddSubHeader("Registered Keybinds List", "rbxassetid://10734975692")
    ...
    Section:AddButton({
        Name = "Refresh Keybinds List",
        Callback = function()
            RefreshKeybindDisplay()
            NamelessWare:Notify({
                Title = "Keybinds Refreshed",
                Content = "Active feature keybinds list has been refreshed.",
                Duration = 1.5,
                Type = "Info"
            })
        end
    ...
    Section:AddSubHeader("Library Management", "rbxassetid://10734950309")
